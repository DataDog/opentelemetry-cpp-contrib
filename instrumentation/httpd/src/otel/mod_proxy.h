...
// This file is copied from an installation of IBM_HTTP_Server/9.0.5.16 (Unix),
// except that the following include (http_ssl.h) has been commented out.
// "http_ssl.h" is not included in the IBM HTTP Server installation, and is not
// otherwise available on Red Hat Enterprise Linux 8.8.
//
// #include "http_ssl.h"
...
PROXY_DECLARE(int) ap_proxy_connection_create_ihs(const char *proxy_function,
                                              proxy_conn_rec *conn,
                                              request_rec *r,
                                              const char *hostname);
